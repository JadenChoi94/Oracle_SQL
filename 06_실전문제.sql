...
INSERT INTO T_TBL1 VALUES ('7369','SMITH','CLERK',7909,
TO_DATE('1980-12-17','YYYY-MM-DD'),800,NULL,20);
INSERT INTO T_TBL1 VALUES ('7566','JONES','MANAGER',7839,
TO_DATE('1981-04-02','YYYY-MM-DD'),2975,NULL,20);
INSERT INTO T_TBL1 VALUES ('7788','SCOTT','ANALYST',7566,
TO_DATE('1987-07-13','YYYY-MM-DD'),3000,NULL,20);
INSERT INTO T_TBL1 VALUES ('7876','ADAMS','CLERK',7788,
TO_DATE('1987-07-13','YYYY-MM-DD'),1100,NULL,20);
INSERT INTO T_TBL1 VALUES ('7902','FORD','ANALYST',7566,
...
--24
SELECT A.* FROM EMP A,(SELECT DEPTNO, MAX(HIREDATE) AS MAX_HIREDATE FROM EMP
GROUP BY DEPTNO) B
...
FROM EMP
WHERE HIREDATE IS NOT NULL ORDER BY HIREDATE DESC)
WHERE ROWNUM < = 5;
...
--28
SELECT JOB FROM (SELECT JOB, STDDEV(SAL) FROM EMP 
